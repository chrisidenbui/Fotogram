...
const active_carousel = document.querySelector('.carousel-item active > img')
openImageTab(active_carousel)

function openImageTab(all_images){
    for (let a = 0; a < all_images.length; a++) {
        all_images[a].addEventListener("click",function (){
            let src = all_images[a].src;
