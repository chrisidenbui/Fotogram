...
public class Likes {
    ...
    private UserAcc liker;  // Like này của User nào.
    ...
    public Likes(UserAcc liker, Post likeAtPost, Timestamp creationDate) {
        this.liker = liker;
    ...
    public UserAcc getLiker() {
        return liker;
    }

    public void setLiker(UserAcc liker) {
        this.liker = liker;
    }
